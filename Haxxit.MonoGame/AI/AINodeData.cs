...
namespace SmartboyDevelopments.Haxxit.MonoGame
{
    ...
    class AINodeData
    {
        ...
        private Maps.Point coordinate;
        public Maps.Point Coordinate { get { return coordinate; } }
        ...
        {
            coordinate = new Maps.Point(column, row);
            isAvailable = false;
            hasSilicoin = false;
            hasData = false;
            isSpawn = false;
        ...
        public bool canHoldCurrentProgram(Maps.ProgramHeadNode program)
        {
            if (isAvailable)
            {
                return true;
