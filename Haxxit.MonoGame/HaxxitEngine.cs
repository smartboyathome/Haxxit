...
namespace SmartboyDevelopments.Haxxit.MonoGame
{
    ...
    public class HaxxitEngine : Microsoft.Xna.Framework.Game
    {
            ...
            : base()
        {
            ...
            GlobalAccessors.mPlayer1 = new Player("ELF");
            GlobalAccessors.mPlayer1.AddSilicoins((ushort) 1500);

            //int gw = Window.ClientBounds.Width;
            //int gh = Window.ClientBounds.Height;
